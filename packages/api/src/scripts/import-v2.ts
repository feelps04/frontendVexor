/**
 * Importa ticks MT5 - debug version
 */
...
async function importV2() {
  console.log('📊 Importando ticks MT5 v2...\n');
  ...
  // 3. Processa - versão simplificada
  const trades: any[] = [];
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    // Cria trade a cada 200 linhas válidas
    if (count % 200 === 0) {
