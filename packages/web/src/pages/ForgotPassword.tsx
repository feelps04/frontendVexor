      ...
      <div className="vexor-auth__container">
        <div className="vexor-auth__card">
          ...
          <div className="vexor-auth__header">
            <h1 className="vexor-auth__title">RECUPERAÇÃO</h1>
            <p className="vexor-auth__subtitle">PROTOCOLO DE RESET DE ACESSO</p>
          </div>

          {success ? (
            <div className="vexor-auth__info">
            ...
            <form onSubmit={onSubmit} className="vexor-auth__form">
              <div className="vexor-auth__field">
                <label className="vexor-auth__label">EMAIL CADASTRADO</label>
